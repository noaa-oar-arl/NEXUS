...
class TestGetHemcoSimulationTime:
    def test_feb29_overlap(self, tmp_path):
        ...
        text = dedent(
            ...
            START:   2024-02-29 20:00:00
            END:     2024-03-01 05:00:00
            TS_EMIS: 3600
            """
        )
    ...
    def test_feb29_12z(self, tmp_path):
        # A slice of one day
        text = dedent(
            """\
            # This file was automatically generated by ...
    ...
    def test_multiday(self, tmp_path):
