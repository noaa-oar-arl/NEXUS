...
if(EXISTS ${ESMFMKFILE})
  ...
  # Look for fully-linked library first, then static, then basic dynamic library
  find_library(esmf_lib NAMES libesmf_fullylinked.so PATHS ${ESMF_LIBSDIR})
  if(esmf_lib MATCHES "esmf_lib-NOTFOUND")
    unset(esmf_lib)
    message(STATUS "Fully-linked ESMF library not found, searching for static library instead")
    find_library(esmf_lib NAMES libesmf.a PATHS ${ESMF_LIBSDIR})
    if(esmf_lib MATCHES "esmf_lib-NOTFOUND")
      unset(esmf_lib)
      message(STATUS "Static ESMF library not found, searching for basic dynamic library instead")
      find_library(esmf_lib NAMES libesmf.so PATHS ${ESMF_LIBSDIR})
      if(esmf_lib MATCHES "esmf_lib-NOTFOUND")
        unset(esmf_lib)
        message(STATUS "No ESMF library was found")
      else()
    ...
    set(_library_type SHARED)
    message(STATUS "Using fully-linked ESMF library: ${esmf_lib}")
  endif()
